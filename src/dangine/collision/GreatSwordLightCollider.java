...
public class GreatSwordLightCollider implements HasDrawable {
    ...
    public GreatSwordLightCollider(int wielderId) {
        ...
        lightSwing = new CombatEvent(colliderId, absolutePosition, LIGHT_HITBOX_SIZE, getOnHitLight(), this);
