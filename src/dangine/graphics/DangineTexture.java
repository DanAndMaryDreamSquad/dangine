...
public class DangineTexture {
    ...
    /**
     * The ID of the texture as far as the graphics card is concerned. This is
     * what you pass into
     * "GL11.glBindTexture(GL11.GL_TEXTURE_2D, int textureId)" i.e.
     * GL11.glBindTexture(GL11.GL_TEXTURE_2D,
     * DangineTextureGenerator.createdTexture);
     */
