...
//    private int texId = DangineTextures.loadPNGTexture("src/assets/images/bgs/snowsky1.png", GL13.GL_TEXTURE0);
    private int texId = DangineTextures.loadPNGTexture("src/assets/images/weapons/greatsword.png", GL13.GL_TEXTURE0);

    public DangineTexturedQuad() {
        setupQuad();
    }
