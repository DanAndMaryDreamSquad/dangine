...
public class TextureExample {
    ...
    private void setupMatrices() {
        ...
        //
        // float y_scale = this.coTangent(this.degreesToRadians(fieldOfView /
        // 2f));
    ...
    private void setupShaders() {
        ...
        // int vsId = this.loadShader("src/dangine/graphics/sample_vertex.glsl",
        // GL20.GL_VERTEX_SHADER);
        // // Load the fragment shader
        // int fsId =
        // this.loadShader("src/dangine/graphics/sample_fragment.glsl",
